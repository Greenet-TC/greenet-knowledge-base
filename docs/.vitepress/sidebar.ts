...
function sidebarKnoeladge() {
  return [
    {
      text: "📕 产品经理基础知识",
      collapsed: false,
      items: [
        { text: "专栏01｜产品入门介绍", link: "/product/base/01" },
        { text: "专栏01｜产品入门介绍", link: "/product/base/02" },
        { text: "专栏01｜产品入门介绍", link: "/product/base/03" },
        { text: "专栏01｜产品入门介绍 ", link: "/product/base/04" },
      ],
    },
    {
      text: "📙 产品面经合集",
      ...
      items: [
        {
          text: "阿里校招产品offer｜武汉大学研究生，年薪35.2 W！",
          link: "/product/base/01",
        },
        { text: "专栏01｜产品入门介绍", link: "/product/base/02" },
        { text: "专栏01｜产品入门介绍", link: "/product/base/03" },
        { text: "专栏01｜产品入门介绍 ", link: "/product/base/04" },
